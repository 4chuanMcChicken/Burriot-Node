  ...
  useEffect(() => {
    const getTokenInfos = async () => {
      try {
        ...
        const now = Date.now();
        // dispatch(setTokenInfo({ data: res, timestamp: now }));
        setTokenInfos(res);
        ...
        >
          <div className="py-10 h-full">
            <div className="flex justify-evenly h-full">
              ...
              <ShineBorder
                className="relative flex w-3/12 flex-col items-center justify-center overflow-hidden rounded-lg bg-background md:shadow-xl"
